...
const events = [
  ...
  },
  {
    ...
    description: 'Três dias de encontro, adoração, comunhão e ativação para jovens que querem viver na frequência do céu. Campfire, música, ensino e tempo para construir relacionamentos na família da igreja.',
